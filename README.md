# Onion Kredits Blockchain Explorer

Currently available Kredits blockchain explorers have several limitations which are of 
special importance to privacy-oriented users:
 ...
 - do not support Kredits testnet nor stagenet networks,
 - have limited JSON API.


In this example, these limitations are addressed by development of
an Onion Kredits Blockchain Explorer. The example not only shows how to use 
Kredits C++ libraries, but also demonstrates how to use:
...
## Onion Kredits Blockchain Explorer features
 ...
 - showing public components of Kredits addresses,
...
git clone https://github.com/kredits-project/onion-kredits-blockchain-explorer.git

# enter the downloaded sourced code folder
cd onion-kredits-blockchain-explorer
...
alias xkrblocksmainnet='~/onion-kredits-blockchain-explorer/build/xkrblocks    --port 8081 --testnet-url "http://139.162.32.245:8082" --enable-pusher --enable-emission-monitor'

# for testnet explorer
alias xkrblockstestnet='~/onion-kredits-blockchain-explorer/build/xkrblocks -t --port 8082 --mainnet-url "http://139.162.32.245:8081" --enable-pusher --enable-emission-monitor'
```
...
```json
{
  "data": {
    ...
    "git_branch_name": "update_to_current_xkri",
    "last_git_commit_date": "2017-07-25",
    "last_git_commit_hash": "a549f25",
    "xkri_version_full": "0.10.3.1-ab594cfe"
  },
  "status": "success"
}
```
